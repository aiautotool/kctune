...
function applyStudioPreset(preset) {
  const presets = {
    ...
    "hq-mp3-441": { hz: targetFrequency(), format: "MP3", bitrate: "320k", sampleRate: "44100", gain: 0, brainwave: $("#brainwave-select")?.value || "none", beat: Number($("#binaural-beat")?.value || 6), binaural: $("#binaural-toggle")?.checked || false, drone: $("#layer-528-toggle")?.checked || false, nature: $("#nature-layer-toggle")?.checked || false, autoTune: $("#auto-tune-toggle")?.checked || false, key: $("#auto-tune-key")?.value || "Auto", scale: $("#auto-tune-scale")?.value || "Major", strength: Number($("#auto-tune-strength")?.value || 55), bass: $("#bass-enhance-toggle")?.checked !== false, bassDb: Number($("#bass-boost-select")?.value || 3), export8d: $("#export-8d-toggle")?.checked || false, speed: Number($("#export-8d-speed")?.value || 0.055), depth: Number($("#export-8d-depth")?.value || 0.68), mastering: currentMasteringPreset || "chill", label: "MP3 HQ 320kbps 44.1kHz", spatial: $("#export-8d-toggle")?.checked ? "8d" : $("#binaural-toggle")?.checked ? "3d" : "off" },
    "hq-flac-441": { hz: targetFrequency(), format: "FLAC", bitrate: "lossless", sampleRate: "44100", gain: 0, brainwave: $("#brainwave-select")?.value || "none", beat: Number($("#binaural-beat")?.value || 6), binaural: $("#binaural-toggle")?.checked || false, drone: $("#layer-528-toggle")?.checked || false, nature: $("#nature-layer-toggle")?.checked || false, autoTune: $("#auto-tune-toggle")?.checked || false, key: $("#auto-tune-key")?.value || "Auto", scale: $("#auto-tune-scale")?.value || "Major", strength: Number($("#auto-tune-strength")?.value || 55), bass: $("#bass-enhance-toggle")?.checked !== false, bassDb: Number($("#bass-boost-select")?.value || 3), export8d: $("#export-8d-toggle")?.checked || false, speed: Number($("#export-8d-speed")?.value || 0.055), depth: Number($("#export-8d-depth")?.value || 0.68), mastering: currentMasteringPreset || "chill", label: "FLAC HQ 44.1kHz", spatial: $("#export-8d-toggle")?.checked ? "8d" : $("#binaural-toggle")?.checked ? "3d" : "off" },
